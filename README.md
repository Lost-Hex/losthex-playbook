...
**This is a GitHub template.** Click "Use this template" to create a client-specific playbook repo.
...
Teardowns are specs with **rebuild assessments**—for each technical decision, we ask: "Would we make this decision again?" Many "No" answers signal significant technical debt.
...
Each client playbook syncs to its own GitBook space for client visibility.

---

## Teardown Template

Copy everything below this line into a new file: `teardowns/TEARDOWN-001-client-name.md`
