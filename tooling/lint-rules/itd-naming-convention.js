...
// e.g., file in "01-foundation/" should have title "# FOUNDATION-ITD-001: ..."

module.exports = {
  names: ["itd-naming-convention"],
  description: "ITD title must include parent directory as uppercase prefix (e.g., FOUNDATION-ITD-001)",
  tags: ["itd", "naming"],
  function: function rule(params, onError) {
    ...
    // "00-foundation" -> "FOUNDATION", "01-process" -> "PROCESS"
